...
/**
 * Полный end-to-end тест, имитирующий поведение пользователя при оформлении заказа в интернет-магазине.
 * Тест охватывает ключевые сценарии работы с системой:
 * Фильтрация товаров по цене и категориям
 * Работа с корзиной и изменение количества товаров
 * Оформление заказа с заполнением персональных данных
 * Реализован с использованием паттерна Screenplay для повышения читаемости и поддерживаемости кода.
 * Интегрирован с Allure для детализированной отчетности по каждому этапу теста.
 *
 * @see BaseTest Базовый класс с настройкой актора и окружения
 *
 */
